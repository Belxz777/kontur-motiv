...
export default function MotivationCardsv2({ cards }: { cards: MotivationCard[] }) {
  ...
  return (
    <div className="relative">
      ...
      Двойной клик что бы посмотреть подробнее.
            ...
            className="bg-blue-500  cursor-pointer select-none font-semibold py-2 px-4 rounded-lg shadow-md transition-colors duration-200 ease-in-out ml-4"
